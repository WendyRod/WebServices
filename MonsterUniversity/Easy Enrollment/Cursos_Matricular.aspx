...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Panel ID="Panel3" runat="server" Height="224px" Width="1462px">
    ...
    <table style="width:100%;">
        <tr>
            <td style="text-align: center; width: 344px;">
                ...
                <asp:ListBox ID="ListBox_Courses" runat="server" AutoPostBack="True" Rows="8" Width="314px" OnSelectedIndexChanged="Course_Selected" ></asp:ListBox>
            </td>
            <td style="text-align: center; width: 368px;">
                Grupos del curso
                <asp:Label ID="Label_Course_Name" runat="server" Text="_______"></asp:Label>
                <br />
                <asp:ListBox ID="ListBox_Groups" runat="server" AutoPostBack="True" Rows="8" Width="327px" OnSelectedIndexChanged="GroupSelected"></asp:ListBox>
            </td>
